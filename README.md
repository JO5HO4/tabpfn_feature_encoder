...
encoder_tabpfn epoch 1/20: train_loss=..., train_accuracy=..., train_roc_auc=..., grad_norm_mean=..., grad_norm_max=..., skipped_nonfinite_updates=0, batches=49/49, val_loss=..., val_accuracy=..., val_roc_auc=...
